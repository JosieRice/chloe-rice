...
export function GitHubCard({
  ...
  return (
    <a
      className="card w-96 bg-accent-content shadow-xl border-solid border-2 border-neutral"
      href={htmlUrl}
      target="_blank"
    >
        ...
        <div className="flex justify-between">
          <div className="flex">
            ...
            <span className="badge badge-outline ml-2">
              {privateBool ? "private" : "public"}
            </span>
          </div>
          <div
            className="tooltip"
            data-tip={`Created: ${new Date(createdAt).toDateString()}`}
          >
